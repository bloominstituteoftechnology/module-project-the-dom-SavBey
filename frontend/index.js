function moduleProject1() {
 ...
 widget1.appendChild(authorDate);
  ...
  const format = `We need to ${randomVerb1} our ${randomNoun1} ${randomAdverb1} in order to ${randomVerb2} our ${randomNoun2} ${randomAdverb2}.`;
 ...
 const id = setInterval(() => {
  if(count === 1 ){
    return countdown.textContent = "Liftoff! 🚀"
    clearInterval(id)
  }
  count--
  countdown.textContent = `T-minus ${count}...`
